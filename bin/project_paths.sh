...
MSG_IPYRAD_DIR="${MSG_DIR}/ipyrad"
MSG_ALIGNMENTS_DIR="${MSG_DIR}/alignments"
BAKEOFF_ALIGNMENTS_DIR="${MSG_DIR}/bakeoff-alignments"

export BIN_DIR BASE_DIR DATA_DIR GENOME_DIR CYRT_GENOME_DIR GEKKO_GENOME_DIR \
        MSG_DIR MSG_PLATE1_DIR MSG_PLATE2_DIR MSG_PLATE3_DIR MSG_IPYRAD_DIR \
        MSG_ALIGNMENTS_DIR BASE_DIR
