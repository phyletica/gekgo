...
\caption{
    ...
    \jroeditnote{We changed the sample size for \spp{G. romblon} from Tablas
        from ``4'' to ``2''. This was an error in the table (i.e., the data,
        analyses, and results have not changed).}
}
\centering
