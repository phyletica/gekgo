...
\spp{Cyrtodactylus} are also found in some of these same habitats, but also
...
Furthermore, we consider it likely that the ephemeral habitat on the
low-elevation land bridges exposed during glacial periods was unsuitable for
