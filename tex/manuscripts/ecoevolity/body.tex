...
times between \spp{G.\ mindorensis} on the Islands of Babuyan Claro and Calayan
and \spp{G.\ porosus} on the Islands of Romblon and Tablas appears to be close
...
= 3.642\e{-5} substitutions per site) is likely close to the minimum resolution
...
of magnitude faster than that estimated for Philippine \spp{Gekko} for the
phosducin gene (1.18\e{-9} substitutions per site per year) and an interglacial
