...
have a large affect on the diversity and distribution of species across an
area.
...
If repeated vicariance was an important process of speciation across the
islands,
...
glacial lowstands, at least some of them should be comtemporaneous with
interglacial fragmentation events.
...
diversification.
By using the all the information in thousands of loci from 16 inter-island
...
\subsection{Inferring diverence models for \spp{Cyrtodactlus}}
...
\subsection{Inferring diverence models for \spp{Gekko}}
...
here does not suffer from the insufficient prior sampling proposed
\citet{Hickerson2013}.
...
probabilities to give use theses posterior probabilities, and
the marginal likelihood of a model is averaged over the entire parameter space,
and weighted by the prior.
...
populations.
While genomic data from more taxa are needed, the results suggest the repeated
cycles of climate-driven island fragmentation has not been an important
mechanism of speciation for gekkonid lizards on the Philippine Islands.
