...
\ecoevolity would have the temporal resolution given our data to 
separate the divergence times of two pairs that diverged during the same
interglacial fragmentation event.
