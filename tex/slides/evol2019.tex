\input{../utils/slide-doc-class-wide-screen.tex}
...
\begin{frame}[t]
    ...
    \begin{columns}
        ...
        \begin{minipage}[t][\textheight][t]{\linewidth}
            ...
            \bigskip
            \uncover<6->{\bf Our goal is to do both.}
            }
        \end{minipage}
...
\begin{frame}[t]
    ...
    \begin{minipage}[t][0.65\textheight][t]{\linewidth}
        \centerline{
        \raisebox{-0.5\height}{\includegraphics<1->[height=0.65\textheight]{../images/photos/Cyrt-philippinicus-small.jpg}}
        % \hspace{1.0mm}
        \raisebox{-0.5\height}{\includegraphics<1->[height=0.65\textheight]{../images/grid-map-philippines.pdf}}
        % \hspace{1.0mm}
        \raisebox{-0.5\height}{\includegraphics<1->[height=0.65\textheight]{../images/photos/Gekko-mindorensis-RMB-22859-small.jpg}}}
    \end{minipage}
