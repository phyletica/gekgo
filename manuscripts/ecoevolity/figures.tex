...
\mFigure{../../data/genomes/msg/ecoevolity-results/pyco-sumsizes-cyrtodactylus-conc5-rate200-pretty-pycoevolity-sizes.pdf}{
    The approximate marginal posterior densities of effective population size
    for each \spp{Cyrtodactylus} population.
}{fig:cyrtpopsizes}

\mFigure{../../data/genomes/msg/ecoevolity-results/pyco-sumsizes-gekko-conc5-rate2000-pretty-pycoevolity-sizes.pdf}{
    The approximate marginal posterior densities of effective population size
